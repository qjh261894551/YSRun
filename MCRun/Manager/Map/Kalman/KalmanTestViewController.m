...
@property (nonatomic, weak) IBOutlet MCNavigationBarView *navigationBar;
...
- (NSArray *)filterWithLocationArray:(NSArray *)locationArray
{
    ...
    for (MCMapAnnotation *annotation in locationArray)
    {
        CLLocationCoordinate2D coordinate = annotation.coordinate;
        ...
        if (newLocationData)
        {
            ...
            MCMapAnnotation *newAnnotation = [[MCMapAnnotation alloc] initWithCoordinate:newCoordinate];
