...
@interface MCMapPaintFunc () <MAMapViewDelegate>

@property (nonatomic, strong) MCMapAnnotation *startAnnotation;
@property (nonatomic, strong) MCMapAnnotation *endAnnotation;

@end

@implementation MCMapPaintFunc
...
- (void)addStartAnnotation:(MCMapAnnotation *)startAnnotation
             endAnnotation:(MCMapAnnotation *)endAnnotation
...
{
    if ([annotation isKindOfClass:[MCMapAnnotation class]])
    {
