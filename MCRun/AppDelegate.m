...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MCMainTabBarViewController *viewController = [[MCMainTabBarViewController alloc] init];
...
//    MCLaunchAnimation *launchAnimation = [MCLaunchAnimation new];
