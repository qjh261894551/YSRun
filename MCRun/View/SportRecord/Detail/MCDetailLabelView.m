...
#import "MCDetailLabelView.h"
#import "MCSuperscriptLabel.h"
#import "MCAppMacro.h"

@interface MCDetailLabelView ()

@property (nonatomic, weak) IBOutlet MCSuperscriptLabel *leftSuperscriptLabel;
@property (nonatomic, weak) IBOutlet MCSuperscriptLabel *rightSuperscriptLabel;
@property (nonatomic, weak) IBOutlet UIView *colorView;

@end

@implementation MCDetailLabelView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCDetailLabelView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
