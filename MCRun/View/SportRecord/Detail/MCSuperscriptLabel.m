...
@implementation MCSuperscriptLabel

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCSuperscriptLabel" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
