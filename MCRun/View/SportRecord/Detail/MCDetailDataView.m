...
@interface MCDetailDataView ()

@property (nonatomic, weak) IBOutlet MCDetailLabelView *detailLabel1;
@property (nonatomic, weak) IBOutlet MCDetailLabelView *detailLabel2;
@property (nonatomic, weak) IBOutlet MCDetailLabelView *detailLabel3;
...
@implementation MCDetailDataView
...
{
    if ((heartRate <= MCGraphDataMiddleSectionMax) && (heartRate >= MCGraphDataMiddleSectionMin))
    {
        return YES;
    }
