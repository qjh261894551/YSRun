...
#import "MCThirdPartShareSelectView.h"
...
@interface MCShareViewController () <MCThirdPartShareSelectViewDelegate>
...
@property (nonatomic, weak) IBOutlet MCMarkLabelsView *dataLabels;
@property (nonatomic, weak) IBOutlet MCThirdPartShareSelectView *shareSelectView;
...
@implementation MCShareViewController

- (id)initWithDataRecordModel:(MCDataRecordModel *)dataRecordModel mapImage:(UIImage *)mapImage
{
    self = [super init];
    if (self)
    {
...
- (void)setupBarView
{
    ...
    self.dateLabel.text = [MCTimeFunc dateStrFromTimestamp:self.dataRecordModel.startTime];
}
...
- (void)setupDataLabel
{
    ...
    CGFloat markFontSize = [MCDevice isPhone6Plus] ? 12 : 10;
...
#pragma mark - MCThirdPartShareSelectViewDelegate
...
- (void)shareType:(MCShareSelectType)type
{
    ...
    MCShareInfo *shareInfo = [MCShareInfo defaultShareInfoWithImages:@[image] contentText:[self getShareContentText]];
    
    SSDKPlatformType platformType = SSDKPlatformTypeUnknown;
    switch (type) {
        case MCShareSelectTypeWXCircleOfFriends:
            platformType = SSDKPlatformSubTypeWechatTimeline;
            break;
            
        case MCShareSelectTypeWXFriends:
            platformType = SSDKPlatformSubTypeWechatSession;
            break;
            
        case MCShareSelectTypeSinaWeibo:
            platformType = SSDKPlatformTypeSinaWeibo;
            break;
            
        case MCShareSelectTypeQQZone:
            platformType = SSDKPlatformSubTypeQZone;
            break;
            
        case MCShareSelectTypeQQFriends:
    ...
    [MCShareFunc shareInfo:shareInfo byPlatform:platformType callbackBlock:callbackBlock];
}
