...
#import "MCBarProgressView.h"
#import "MCPaceSectionDataModel.h"
#import "MCDevice.h"
#import "MCAppMacro.h"

@interface MCPaceDataItem ()

@property (nonatomic, weak) IBOutlet UILabel *numberLabel;
@property (nonatomic, weak) IBOutlet UILabel *paceValueLabel;
@property (nonatomic, weak) IBOutlet MCBarProgressView *barProgress;

@property (nonatomic, strong) MCPaceSectionDataModel *sectionDataModel;

@end

@implementation MCPaceDataItem
...
- (void)setupWithPaceSectionDataModel:(MCPaceSectionDataModel *)model
{
