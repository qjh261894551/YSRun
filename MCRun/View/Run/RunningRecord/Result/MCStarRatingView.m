...
@implementation MCStarRatingView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCStarRatingView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
