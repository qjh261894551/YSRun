...
#import "MCStarRatingView.h"
#import "MCRunInfoModel.h"
#import "MCResultHeartRateDataLabels.h"
#import "MCResultRunDataLabels.h"
#import "MCTimeFunc.h"
#import "MCCalorieCalculateFunc.h"
#import "MCHeartRateDataManager.h"
#import "MCDevice.h"
#import "MCResultDataLabelsView.h"
#import "MCResultTipView.h"
#import "MCPopView.h"
#import "MCRatingDetailView.h"

@interface MCResultRecordView () <MCResultHeartRateDataLabelsDelegate, MCResultRunDataLabelsDelegate, MCResultTipViewDelegate>

@property (nonatomic, weak) IBOutlet MCStarRatingView *starRattingView;
@property (nonatomic, weak) IBOutlet UIImageView *bgImageView;

@property (nonatomic, weak) IBOutlet MCResultDataLabelsView *resultDataLabelsView;
@property (nonatomic, weak) IBOutlet MCResultTipView *tipView;
...
@implementation MCResultRecordView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCResultRecordView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
...
- (void)showDataLabelsWithRunInfoModel:(MCRunInfoModel *)runInfoModel
{
    CGFloat kilometre = runInfoModel.distance / 1000;
    NSString *timeStr = [MCTimeFunc timeStrFromUseTime:runInfoModel.useTime];
    CGFloat calorie = [MCCalorieCalculateFunc calculateCalorieWithWeight:65 distance:kilometre];
    ...
    if (hasHeartRateData)
    {
        CGFloat proportion = [MCHeartRateDataManager efficientProportionWithHeartRateArray:runInfoModel.heartRateArray];
...
//    {
//        // 有心率熟虑时多显示一个心率达标标签
//        self.heartRateDataLabels = [[[UINib nibWithNibName:@"MCResultHeartRateDataLabels" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
...
//    else
//    {
//        self.runDataLabels = [[[UINib nibWithNibName:@"MCResultRunDataLabels" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
...
#pragma mark - MCResultHeartRateDataLabelsDelegate
...
#pragma mark - MCResultRunDataLabelsDelegate
...
#pragma mark - MCResultTipViewDelegate
...
- (void)showHelpFromPoint:(CGPoint)point
{
    ...
    // 添加提示内容的视图
    MCRatingDetailView *detailView = [[[UINib nibWithNibName:@"MCRatingDetailView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
