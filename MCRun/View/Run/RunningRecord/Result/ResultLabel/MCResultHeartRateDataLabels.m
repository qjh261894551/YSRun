...
@interface MCResultHeartRateDataLabels ()
...
@implementation MCResultHeartRateDataLabels

//- (id)initWithCoder:(NSCoder *)aDecoder
//{
//    if (self = [super initWithCoder:aDecoder])
//    {
//        UIView *containerView = [[[UINib nibWithNibName:@"MCResultHeartRateDataLabels" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
//        
