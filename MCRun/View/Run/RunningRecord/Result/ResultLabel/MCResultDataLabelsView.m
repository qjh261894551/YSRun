...
#import "MCMarkLabel.h"
#import "MCDevice.h"

@interface MCResultDataLabelsView ()

@property (nonatomic, weak) IBOutlet MCMarkLabel *distanceMarkLabel;
@property (nonatomic, weak) IBOutlet MCMarkLabel *timeMarkLabel;
@property (nonatomic, weak) IBOutlet MCMarkLabel *calorieMarkLabel;

@property (nonatomic, weak) IBOutlet UILabel *standardRateLabel;

@end

@implementation MCResultDataLabelsView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCResultDataLabelsView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
