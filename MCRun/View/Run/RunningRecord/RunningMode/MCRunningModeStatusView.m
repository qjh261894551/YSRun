...
@interface MCRunningModeStatusView ()
...
@implementation MCRunningModeStatusView

//- (id)initWithCoder:(NSCoder *)aDecoder
//{
//    if (self = [super initWithCoder:aDecoder])
//    {
//        UIView *containerView = [[[UINib nibWithNibName:@"MCRunningModeStatusView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
//        
