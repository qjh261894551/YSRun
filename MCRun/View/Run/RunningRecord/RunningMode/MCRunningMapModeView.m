...
@interface MCRunningMapModeView () <MCMapManagerDelegate>
...
@implementation MCRunningMapModeView

- (void)addBackView
{
    if (!self.mapManager)
    {
        self.mapManager = [[MCMapManager alloc] init];
...
- (void)resetLayoutWithFrame:(CGRect)frame
{
    ...
    [self.pulldownView setAppearanceWithType:MCPulldownTypeMapMode];
}
...
- (void)setupButtonsAppearance
{
    ...
    [self.pulldownView setAppearanceWithType:MCPulldownTypeGeneralMode];
...
#pragma mark - MCMapManagerDelegate
