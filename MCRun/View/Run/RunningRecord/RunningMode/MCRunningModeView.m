...
#import "MCRunningModeView+GetMethod.h"
...
@interface MCRunningModeView () <MCRunningModeStatusViewDelegate>

@end

@implementation MCRunningModeView
...
- (void)addSubviews
{
    self.timeLabel = [[[UINib nibWithNibName:@"MCTimeLabel" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
    self.timeLabel.userInteractionEnabled = NO;
    [self addSubview:self.timeLabel];
    
    self.distanceLabel = [[[UINib nibWithNibName:@"MCSubscriptLabel" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
    self.distanceLabel.userInteractionEnabled = NO;
    [self.distanceLabel setSubscriptText:@"公里"];
//    [self addSubview:self.distanceLabel];
    
    self.paceLabel = [[[UINib nibWithNibName:@"MCSubscriptLabel" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
    self.paceLabel.userInteractionEnabled = NO;
    [self.paceLabel setSubscriptText:@"配速(分/公里)"];
//    [self addSubview:self.paceLabel];
    
    self.heartRateLabel = [[[UINib nibWithNibName:@"MCSubscriptLabel" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
...
//    [self addSubview:self.heartRateLabel];
    ...
    self.dataView = [[[UINib nibWithNibName:@"MCRunningModeDataView" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
    self.dataView.userInteractionEnabled = NO;
    [self addSubview:self.dataView];
    
    self.modeStatusView = [[[UINib nibWithNibName:@"MCRunningModeStatusView" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
    ...
    self.pulldownView = [MCPulldownView defaultPulldownViewWithRadius:kPulldownViewRadius];
...
#pragma mark - MCRunningModeStatusViewDelegate
