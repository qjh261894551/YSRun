...
@interface MCDataRecordLabelsView ()
...
@implementation MCDataRecordLabelsView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCDataRecordLabelsView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
