...
@interface MCCalendarWeekdayView ()
...
@implementation MCCalendarWeekdayView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCCalendarWeekdayView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
