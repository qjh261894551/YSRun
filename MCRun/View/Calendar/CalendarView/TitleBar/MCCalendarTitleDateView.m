...
@interface MCCalendarTitleDateView ()

@property (nonatomic, weak) IBOutlet UILabel *label;

@end

@implementation MCCalendarTitleDateView
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCCalendarTitleDateView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
