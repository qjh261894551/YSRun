...
//@property (nonatomic, strong) MCDataRecordModel *model;
...
@implementation MCRunDataRecordCell
...
{
    MCChartData *charData = [self getChartDataWithArray:heartRateArray];
    [self.barChart setupWithChartData:charData];
    [self.barChart setNeedsDisplay];
}

- (MCChartData *)getChartDataWithArray:(NSArray *)array
{
