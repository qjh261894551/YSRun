...
@interface MCContentHelp ()

@property (nonatomic, strong) UIView *backgroundView;
@property (nonatomic, strong) MCContentHelpView *helpView;

@end

@implementation MCContentHelp

- (void)showHelpFromPoint:(CGPoint)point
{
    self.helpView = [[[UINib nibWithNibName:@"MCContentHelpView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
