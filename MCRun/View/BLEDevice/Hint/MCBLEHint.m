...
#import "MCBLEHint.h"
#import "MCBLEConnectHintView.h"
#import "MCBLEConnectFailureHintView.h"
#import "MCAppSettingsDefine.h"
#import "MCConfigManager.h"

@interface MCBLEHint () <UIGestureRecognizerDelegate, MCBLEConnectHintViewDelegate, MCBLEConnectFailureHintViewDelegate, UIAlertViewDelegate>
...
{
//    self.hintView = [[[UINib nibWithNibName:@"MCBLEConnectHintView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
//    ((MCBLEConnectHintView *)self.hintView).delegate = self;
//    
//    [self showHint];
...
{
//    self.hintView = [[[UINib nibWithNibName:@"MCBLEConnectFailureHintView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
//    ((MCBLEConnectFailureHintView *)self.hintView).delegate = self;
//    
//    [self showHint];
...
#pragma mark - MCBLEConnectHintViewDelegate
...
{
    [MCConfigManager setBLEConnectHintHidden:hidden];
}

#pragma mark - MCBLEConnectFailureHintViewDelegate
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (alertView == self.bleConnectHint)
    {
        ...
        switch (buttonIndex)
        {
            case 0:
                // 不再提示
                [MCConfigManager setBLEConnectHintHidden:YES];
                [self.delegate runDirectly];
                break;
