...
@implementation MCLoadingDotView
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCLoadingDotView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
