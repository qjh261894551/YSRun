...
#import "MCBurningMarkView.h"
#import "MCAppMacro.h"

@interface MCBurningMarkView ()
...
@implementation MCBurningMarkView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCBurningMarkView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
