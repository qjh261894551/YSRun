...
@interface MCBLEHeartRateCountingView ()

@property (nonatomic, weak) IBOutlet MCBurningMarkView *burningMarkView;
...
@implementation MCBLEHeartRateCountingView
