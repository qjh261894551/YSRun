...
@interface MCEditingCheckLengthLimit ()

@property (nonatomic, assign) NSInteger maxLimit;
@property (nonatomic, weak) id<MCEditingCheckLengthLimitDelegate> delegate;

@end

@implementation MCEditingCheckLengthLimit
