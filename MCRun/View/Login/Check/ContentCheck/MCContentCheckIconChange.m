...
@interface MCContentCheckIconChange ()

@property (nonatomic, weak) id<MCContentCheckIconChangeDelegate> delegate;

@end

@implementation MCContentCheckIconChange
