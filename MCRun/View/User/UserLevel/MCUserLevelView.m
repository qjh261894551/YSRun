...
#import "MCCicularProgressView.h"
#import "MCAppMacro.h"
...
@property (nonatomic, weak) IBOutlet MCWaveProgressView *waveProgressView;
@property (nonatomic, weak) IBOutlet MCMedalView *medalView;
...
//@property (nonatomic, strong) MCCicularProgressView *cicularProgress;
@property (nonatomic, assign) CGFloat progress;

@end

@implementation MCUserLevelView
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCUserLevelView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
...
- (void)addProgress
{
    ...
    self.cicularProgress = [[MCCicularProgressView alloc] initWithFrame:frame lineWidth:lineWidth];
    self.cicularProgress.backgroundColor = [UIColor clearColor];
