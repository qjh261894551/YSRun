...
@implementation MCAchievementView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCAchievementView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
