...
@interface MCHeartRateScopeTipView ()
...
@implementation MCHeartRateScopeTipView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCHeartRateScopeTipView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
