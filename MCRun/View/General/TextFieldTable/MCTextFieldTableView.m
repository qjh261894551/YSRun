...
@interface MCTextFieldTableView ()
...
@implementation MCTextFieldTableView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCTextFieldTableView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
