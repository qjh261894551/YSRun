...
@interface MCMarkLabelsView ()

@property (nonatomic, weak) IBOutlet MCMarkLabel *leftLabel;
@property (nonatomic, weak) IBOutlet MCMarkLabel *centerLabel;
@property (nonatomic, weak) IBOutlet MCMarkLabel *rightLabel;

@end

@implementation MCMarkLabelsView

- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        UIView *containerView = [[[UINib nibWithNibName:@"MCMarkLabelsView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
