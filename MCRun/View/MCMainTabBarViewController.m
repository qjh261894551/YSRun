...
@interface MCMainTabBarViewController () <MCRunViewControllerDelegate, MCUserViewControllerDelegate>

@property (nonatomic, strong) MCCalendarViewController *calendarViewController;
@property (nonatomic, strong) MCRunViewController *runViewController;
@property (nonatomic, strong) MCUserViewController *userViewController;
...
{
    self.runViewController = [[MCRunViewController alloc] init];
...
{
    self.userViewController = [[MCUserViewController alloc] init];
...
#pragma mark - MCRunViewControllerDelegate
...
#pragma mark - MCUserViewControllerDelegate
