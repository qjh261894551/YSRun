...
@interface MCDatabaseQueue : NSObject
...
- (NSInteger)insertRunData:(MCRunDatabaseModel *)runData;   // 本地插入跑步数据,返回跑步数据的id
- (void)insertUser:(MCUserDatabaseModel *)userInfo;    // 插入用户
