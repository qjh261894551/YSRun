...
+ (void)shareInfo:(MCShareInfo *)shareInfo fromView:(UIView *)view callbackBlock:(ShareFuncCallbackBlock)callbackBlock
{
    ...
    [ShareSDK showShareActionSheet:view
               ...
               onShareStateChanged:^(SSDKResponseState state, SSDKPlatformType platformType, NSDictionary *userData, SSDKContentEntity *contentEntity, NSError *error, BOOL end) {
                   ...
                   switch (state) {
                       ...
                       {
                           callbackBlock(MCShareFuncResponseStateSuccess);
                                 ...
                                 callbackBlock:(ThirdPartLoginCallbackBlock)callbackBlock
{
    ...
    if ([ShareSDK isClientInstalled:SSDKPlatformTypeWechat])
    {
        [alertController addAction: [UIAlertAction actionWithTitle: @"微信" style: UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
            [MCShareFunc thirdPartLoginByPlatform:SSDKPlatformTypeWechat callbackBlock:callbackBlock];
        }]];
    }
    ...
    if ([ShareSDK isClientInstalled:SSDKPlatformTypeQQ])
    {
        [alertController addAction: [UIAlertAction actionWithTitle: @"QQ" style: UIAlertActionStyleDefault handler:^(UIAlertAction *action){
            [MCShareFunc thirdPartLoginByPlatform:SSDKPlatformTypeQQ callbackBlock:callbackBlock];
        }]];
    }
    ...
    if ([ShareSDK isClientInstalled:SSDKPlatformTypeSinaWeibo])
    {
        [alertController addAction: [UIAlertAction actionWithTitle: @"新浪微博" style: UIAlertActionStyleDefault handler:^(UIAlertAction *action){
            [MCShareFunc thirdPartLoginByPlatform:SSDKPlatformTypeSinaWeibo callbackBlock:callbackBlock];
        }]];
    }
                   ...
                   callbackBlock:(ThirdPartLoginCallbackBlock)callbackBlock
{
    [SSEThirdPartyLoginHelper loginByPlatform:platform
        ...
        onLoginResult:^(SSDKResponseState state, SSEBaseUser *user, NSError *error) {
            ...
            MCThirdPartLoginResponseModel *model = nil;
            MCShareFuncResponseState responseState = MCShareFuncResponseStateBegin;
            if (state == SSDKResponseStateSuccess)
            {
                responseState = MCShareFuncResponseStateSuccess;
                model = [MCThirdPartLoginResponseModel new];
            ...
            {
//                responseState = MCShareFuncResponseStateFail;
            }
            else if (state == SSDKResponseStateCancel)
            {
//                responseState = MCShareFuncResponseStateCancel;
            }
...
+ (BOOL)hasAuthorized
{
    NSArray *platforms = [MCShareFunc platforms];
