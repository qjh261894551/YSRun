...
@interface MCThirdPartLoginFunc ()

@property (nonatomic, strong) MCIconActionSheet *actionSheet;

@end

@implementation MCThirdPartLoginFunc
...
- (void)showActionSheet
{
    ...
    {
        self.actionSheet = [[MCIconActionSheet alloc] initWithDictArray:dictArray];
...
{
    NSDictionary *dict = @{MCIconActionSheetItemIconKey : image,
                           MCIconActionSheetItemTextKey : text,
                           MCIconActionSheetItemSelectorStringKey : selectorStr,
                           MCIconActionSheetItemObjectKey : object};
    return dict;
}
...
{
    // 登录之后的回调
    ThirdPartLoginCallbackBlock callback = ^(MCShareFuncResponseState state, MCThirdPartLoginResponseModel* responseModel)
    {
    ...
    [MCShareFunc thirdPartLoginByPlatform:platform callbackBlock:callback];
